...
class CustomTabWidget extends StatelessWidget {
  CustomTabWidget({
    ...
    @required this.height,
        ...
        titleBackgroundColor = Colors.white,
        labelColor = AppColors.cmb_grey[100],
        unselectedLabelColor = AppColors.cmb_grey[600],
        indicatorColor = Colors.black {
    assert(pages.isNotEmpty);
    assert(pages.length == pageNum);
  }
          ...
          children: <Widget>[
            Align(
              ...
              child: TabBar(
                ...
                indicator: BoxDecoration( // TODO: 넘 뚱뚱
                  borderRadius: BorderRadius.circular(30),
                  color: indicatorColor,
                ),
                tabs: _buildTabTitleList(),
            ...
            SizedBox(
              height: height,
              child: TabBarView( // TODO: no animation
                physics: NeverScrollableScrollPhysics(),
                children: _buildPagesList(),
              ),
            ),
